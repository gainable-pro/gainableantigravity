...
export async function GET(req: Request) {
    ...
    const type = searchParams.get("type") || "1"; // "1" = Prospect Payment, "2" = Activation
    ...
    <div style="font-family: Arial, sans-serif; color: #333; max-width: 600px; margin: 20px auto; border: 1px solid #e2e8f0; border-radius: 12px; overflow: hidden; background-color: #ffffff; box-shadow: 0 4px 15px rgba(0,0,0,0.08);">
        ...
        <div style="padding: 30px;">
            <div style="background-color: #ECFDF5; border: 1px solid #A7F3D0; padding: 12px 18px; margin-bottom: 20px; color: #065F46; font-weight: bold; text-align: center; border-radius: 8px;">
    ...
    const htmlContent = type === "2" ? email2Html : email1Html;
