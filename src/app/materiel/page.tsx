          ...
          <div className="flex flex-col md:flex-row gap-6 items-start">
            ...
            <div className="flex-1">
              ...
              <div className="mt-6 flex flex-wrap gap-4 items-center border-t border-slate-100 pt-4">
                ...
                <Link href="/contact" className="ml-auto inline-flex items-center gap-2 px-4 py-2 bg-[#1F2D3D] hover:bg-[#D59B2B] text-white text-xs font-semibold rounded-lg transition-all shadow-sm">
