export const b2bArticles = [
    ...
    },
    {
        ...
        contentHtml: `
            ...
            <p>Aujourd'hui, il faut du brand content, de l'humain. Le client veut voir votre visage en vidéo, vos camions, vos chantiers en temps réel pour être rassuré.</p>
    ...
    },
    {
        ...
        contentHtml: `
            <h2>Sprint (Achats) vs Marathon (SEO)</h2>
    ...
    {
        title: "Calculez le vrai Coût d'Acquisition (CAC) de vos chantiers",
        ...
        contentHtml: `
            ...
            <h2>Divisez Votre CAC par 10</h2>
    ...
    {
        title: "Maillage Local : Devenir le seul recommandé par Google",
